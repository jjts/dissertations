...
\vspace{2.5cm}
% height = 50 mm
%\includegraphics[height=50mm]{Figures/predictions.jpg}

% Title, author and degree
\vspace{1.0cm}
{\FontLb CGRA-Based Deep Neural Network For Object Identification} \\ % <<<<< EDIT TITLE
%\vspace{0.2cm}
%{\FontMn Subtitle (optional)} \\
%\vspace{1.9cm}
\vspace{2.6cm}
{\FontMb Pedro José Runa Miranda} \\ % <<<<< EDIT NAME
\vspace{2.0cm}
%{\FontSn \coverThesis} \\
\vspace{0.3cm}
...
{\FontSn %
\begin{tabular}{ll}
 \coverSupervisors: & Prof. Horácio Neto \\ % <<<<< EDIT NAME
                    & Prof. José Teixeira de Sousa    % <<<<< EDIT NAME
\end{tabular} } \\
%\vspace{1.0cm}
