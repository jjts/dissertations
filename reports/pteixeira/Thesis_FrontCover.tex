...
\vspace{3.0cm}
{\FontLb Asynchronous Audio Sample Rate Converter} \\ % <<<<< EDIT TITLE
%\vspace{0.2cm}
%{\FontMn Subtitle (optional)} \\
%\vspace{1.9cm}
\vspace{2.6cm}
{\FontMb Pedro Miguel Portela Teixeira} \\ % <<<<< EDIT NAME
\vspace{2.0cm}
{\FontSn \coverThesis} \\
\vspace{0.3cm}
...
Member of the Committee: Dr. Marco António da Mota Carvalho Silva Pereira % <<<<< EDIT NAME
\end{tabular} } \\
\vspace{1.5cm}
