...
\input{Thesis_Estado_da_arte} % file "Thesis_Estado_da_arte.tex"

\input{Thesis_SPI} % Thesis_Spi.tex

\input{Thesis_I2C} % Thesis_I2C.tex

\input{Thesis_Interface_FIFO} %Thesis_Interface_FIFO

\input{Thesis_Bootrom} %Thesis_Bootrom

\input{Thesis_Testes} %Thesis_Teste
