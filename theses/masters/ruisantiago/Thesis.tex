...
\input{Thesis_trabalho_anterior} % file "Thesis_Estado_da_arte.tex"

\input{Thesis_Arquitectura_do_Versat} % Thesis_Spi.tex

\input{Thesis_compilador_basico} % Thesis_I2C.tex

\input{Thesis_estrutura_compilador} % Thesis_I2C.tex

\input{Thesis_resultados} % Thesis_I2C.tex
