...
%\addbibresource(Thesis\_bib\_DB)
...
\usepackage{comment} % support comments
\usepackage{indentfirst} % ident first line
%\usepackage[nomain, acronym, toc]{glossaries}
\usepackage{acronym}

%\makeglossaries

\input{Thesis_Acronyms_plural} % file "Thesis_Acronyms_plural.tex"
